...
| D-038 | QuestAcceptPopup 1920 redesign | **Accepted, revised — 2026-09-23** | Quest Accept là popup dọc giữa màn hình `320×400` trên Canvas `800×600`, dùng board gỗ/vàng/sapphire đồng bộ HUD. Category, objective và reward icons cùng toàn bộ text là dữ liệu động trên hierarchy prefab thật; board không bake reward socket và runtime chỉ hiện đúng số item reward thực tế. Popup chỉ presentation và giữ nguyên callback Accept/Decline, quest progression và save contract hiện có. | Quest content production |
